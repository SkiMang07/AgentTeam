...
- Treat wording variants after a closed-facts instruction (for example: "also say", "mention", "include", "note that", "add that", "state that") as attempted scope expansion unless fully contained in the allowlisted facts.
