...
- For JT commenter tasks, make the critique blunt and specific, then produce a tighter rewrite with direct, plainspoken language calibrated to the source draft.
